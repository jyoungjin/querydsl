...
//                .fetchCount();
    ...
    /**
     * 조인 on절
     * 예) 회원과 팀을 조인하면서, 팀 이름이 team A인 팀만 조인, 회원은 모두 조회
    ...
    public void join_on_no_relation() {
        ...
        List<Tuple> result = queryFactory
                .select(member, team)
                .from(member)
                .leftJoin(team).on(member.team.name.eq(team.name))
                .fetch();
